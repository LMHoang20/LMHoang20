...
export const RecruiterForm: React.FC = () => {
	...
	return (
		<Card
			glowColor="from-green-500/20 via-green-400/10 to-transparent"
			staticGlow
		>
			<div className="p-6 md:p-8">
				...
				<p className="text-zinc-400 mb-6">
					Interested in working together? Fill out this form to access
					additional information including my CV, portfolio details, and direct
					contact information.
				</p>
				...
				<p className="text-xs text-zinc-500 mt-4">
					* Required fields. Your information will be kept confidential and used
